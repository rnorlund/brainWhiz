...
// 3) MNI brain-envelope prior (threshold the template)
const mthr=otsu(mni.data)*0.5; const mniMask=new Int32Array(mni.data.length); for(let i=0;i<mni.data.length;i++) mniMask[i]= mni.data[i]>mthr?1:0;
